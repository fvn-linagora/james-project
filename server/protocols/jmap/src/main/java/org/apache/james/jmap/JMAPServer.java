    ...
    private JMAPServer(PortConfiguration portConfiguration,
        ...
        server = JettyHttpServer.create(
                configurationBuilderFor(portConfiguration)
                        ...
                        .filter("/authentication").with(new CORSWhitelistFilter(new BypassOnPostFilter(authenticationFilter)))
                        .serve("/jmap").with(jmapServlet)
                        .filter("/jmap").with(new CORSWhitelistFilter(authenticationFilter))
                        .build());
    }
